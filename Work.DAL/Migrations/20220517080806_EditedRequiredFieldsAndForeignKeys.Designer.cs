...
namespace Work.DAL.Migrations
{
    ...
    [Migration("20220517080806_EditedRequiredFieldsAndForeignKeys")]
    partial class EditedRequiredFieldsAndForeignKeys
    {
            ...
            modelBuilder.Entity("Work.DAL.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("HotelTicketReservationId");
            ...
            modelBuilder.Entity("Work.DAL.Entities.Order", b =>
                {
                    b.HasOne("Work.DAL.Entities.HotelTicket", "HotelReservationTicket")
                        .WithMany()
                        .HasForeignKey("HotelTicketReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
