...
namespace Work.DAL.Migrations
{
    ...
    [Migration("20220517100319_ChangedForeignKeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Work.DAL.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("HotelTicketId");

                    b.HasIndex("TourId");

                    b.HasIndex("TransportTicketId");
            ...
            modelBuilder.Entity("Work.DAL.Entities.Order", b =>
                {
                    b.HasOne("Work.DAL.Entities.HotelTicket", "HotelTicket")
                        .WithMany()
                        .HasForeignKey("HotelTicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Work.DAL.Entities.TransportTicket", "TransportTicket")
                        .WithMany()
                        .HasForeignKey("TransportTicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("HotelTicket");

                    b.Navigation("Tour");

                    b.Navigation("TransportTicket");
